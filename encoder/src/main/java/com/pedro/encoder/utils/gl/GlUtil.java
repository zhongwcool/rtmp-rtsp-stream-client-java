...
public class GlUtil {
  ...
  public static void createTextures(int quantity, int[] texturesId, int position) {
    GLES20.glGenTextures(quantity, texturesId, position);
  ...
  public static void createExternalTextures(int quantity, int[] texturesId, int position) {
    GLES20.glGenTextures(quantity, texturesId, position);
    for (int i = 0; i < quantity; i++) {
      GLES20.glActiveTexture(GLES20.GL_TEXTURE0 + position + i);
